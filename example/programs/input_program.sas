...
libname data "/schaeffer-a/sch-projects/public-data-projects/USERS/pferido/Verified_Dementia_Package/data";
...
%demv(projhome=/schaeffer-a/sch-projects/public-data-projects/USERS/pferido/Verified_Dementia_Package,
	  id=bene_id,
	  minyear=2014,
	  maxyear=2017,
	  dxclaims=data.inputclaims,
	  vyear=1,
	  outprefix=data.dem,
	  userx=N,
	  rxclaims=,
